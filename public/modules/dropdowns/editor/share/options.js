modules["dropdowns/editor/share/options"] = {
  ...
  `,
  css: {
    ".eShareActionOption": `display: flex; width: 300px; max-width: calc(100% - 14px); padding: 6px; margin: 7px 7px 11px 7px; align-items: center; --borderWidth: 3px; --borderColor: var(--hover); --borderRadius: 18px; justify-content: center; align-items: center; font-size: 16px; font-weight: 700; text-align: left`,
    ...
    ".eShareActionOption[on]": `--themeColor: var(--theme); --color: #fff`,
    ".eShareActionOption[off]": `--themeColor: var(--gray); --color: #000`,
    ...
    ".eShareActionOption:hover": `background: var(--themeColor); --borderWidth: 0px; transform: scale(1.05); color: var(--color)`,
