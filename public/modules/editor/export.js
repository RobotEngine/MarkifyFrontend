          ...
          if (pageID != null) {
            ...
            if (annotation != null) {
              ...
              if (element != null) {
                ...
                return { capture: true, done: false, width: (annotation.render.s[0] - ((pageBorderWidth * 2) / editor.zoom)), height: (annotation.render.s[1] - ((pageBorderWidth * 2) / editor.zoom)), page: currentPage - 1 }; //) * editor.zoom
              }
            }
          }
          break;
