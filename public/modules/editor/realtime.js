        ...
        if (selectKeys.length > 0) {
          ...
          for (let i = 0; i < selectKeys.length; i++) {
            ...
            if (selection != null) {
              ...
              selection.style.width = ((width * editor.zoom) - 3) + "px";
              selection.style.height = ((height * editor.zoom) - 3) + "px";
          ...
          if (userSelecting == true && changes == true) { // Only refresh if user is selecting
            editor.pipeline.publish("redraw_selection", { refreshActionBar: true, redrawCurrentAction: true });
