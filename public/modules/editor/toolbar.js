...
modules["editor/toolbar/font"] = class {
  ...
  js = async (frame) => {
    ...
    frame.addEventListener("click", async (event) => {
      ...
      this.redraw(font);
      this.setActionButton();
      this.parent.selection.closeActionFrame();
    });
...
modules["editor/toolbar/link"] = class {
  setActionButton = async (button) => {
    setSVG(button, "../images/editor/toolbar/link.svg");
  }
  ...
  <div class="eSubToolLinkContainer">
    ...
    <button title="Remove this hyperlink."><div image></div></button>
  </div>
  `;
  css = {
  ...
  js = async (frame) => {
    ...
    setSVG(removeButton.querySelector("div"), "../images/editor/file/delete.svg");
  }
}
