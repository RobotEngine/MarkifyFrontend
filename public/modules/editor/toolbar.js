modules["editor/toolbar"] = class {
  ...
  css = {
    ...
    ".eActionContainer[top]": `--shadowPadding: 20px 16px 0; --shadowBottom: -4px; --shadowTop: 16px; bottom: 100%; border-radius: 12px 12px 0 0; border-bottom: solid 4px var(--theme); transform-origin: bottom center`,
    ".eActionContainer[bottom]": `--shadowPadding: 0 16px 20px; --shadowBottom: -16px; --shadowTop: 0px; top: 100%; border-radius: 0 0 12px 12px; border-top: solid 4px var(--theme); transform-origin: top center`,
