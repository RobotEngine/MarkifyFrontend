modules["modals/tutorial"] = {
  ...
  <div class="dmWelcome">
    ...
    <div class="dmButtons">
      <button class="dmTutorialButton largeButton" type="usecase" style="--rgbTheme: 255, 185, 56" modal="modals/tutorial/resources">
        <img src="./images/tutorial/lightbulb.svg">
        <div>What You Can Use Markify For</div>
      </button>
      <button class="dmTutorialButton largeButton" type="started" style="--rgbTheme: 52, 193, 114" modal="modals/tutorial/resources">
        <img src="./images/tutorial/compass.svg">
        <div>Getting Started with Markify</div>
      </button>
      <button class="dmTutorialButton largeButton" type="watchout" style="--rgbTheme: 255, 61, 100" modal="modals/tutorial/resources">
...
modules["modals/tutorial/resources"] = {
  html: `
  ...
  js: async function (frame, extra) {
    ...
    let updatePage = async () => {
      ...
      if (info == null) {
        return (await getModule("modal")).open("modals/tutorial", null, null, false);
      }
