...
export class LessonFrame {
  ...
  css = {
    ...
    ".dTileInfoHolder": `position: absolute; box-sizing: border-box; display: flex; width: 100%; padding: 10px; left: 0px; bottom: 0px; align-items: flex-end; background: var(--pageColor); box-shadow: var(--shadow); transition: .2s`,
    ".dTileInfo": `width: 100%`,
    ...
    ".dTileMemberCount": `position: absolute; box-sizing: border-box; display: flex; padding: 6px; right: 0px; top: 0px; align-items: center; background: var(--pageColor); box-shadow: var(--shadow); border-radius: 0 0 0 12px; opacity: 0; transition: .4s`,
