...
export class Frame {
  ...
  <div class="dSidebarActionFrameBrText">Assign members into individual or team whiteboards! Monitor each team in real-time and keep track of each member's contributions.</div>
  ...
  css = {
    ...
    ".dSidebarActionFrameBrText": `box-sizing: border-box; width: 100%; padding: 0 8px; margin-top: 8px; font-size: 14px; line-height: 150%`,
