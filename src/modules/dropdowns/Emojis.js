...
export class Frame {
  ...
  css = {
    ...
    ".eEmojiSectionTitle": `position: sticky; width: calc(100% - 16px); padding: 4px 8px; top: 0px; background: rgba(var(--background), .8); backdrop-filter: blur(4px); z-index: 2; text-align: left; font-weight: 600; font-size: 18px`,
