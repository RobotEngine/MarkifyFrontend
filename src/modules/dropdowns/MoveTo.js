...
export class Frame {
  ...
  css = {
    ...
    ".dTileDropFolder div[arrow]": `position: sticky; display: flex; width: 32px; height: 32px; right: -2px; margin-left: auto; justify-content: center; align-items: center; background: rgba(var(--background), .9); backdrop-filter: blur(4px); border-radius: 16px; z-index: 1; transition: .1s`,
    ".dTileDropFolder div[arrow] svg": `width: 24px; height: 24px`,
    ".dTileDropFolder[loaded] div[arrow]": `transform: rotate(90deg)`,
    ".dTileDropFolderActions": `position: sticky; display: flex; flex-wrap: wrap; max-width: calc(var(--dropdownWidth) - 36px); padding: 8px; margin: 4px; gap: 24px; left: 4px; bottom: 4px; justify-content: space-between; align-items: center; background: rgba(var(--background), .9); backdrop-filter: blur(4px); border-radius: 27px; z-index: 2`,
