...
export class Editor {
  ...
  css = {
    ...
    ".eReaction": `display: flex; padding: 2px; background: rgba(var(--background), .9); border: solid 2px rgba(0, 0, 0, 0); border-radius: 8px; align-items: center; overflow: hidden`,
