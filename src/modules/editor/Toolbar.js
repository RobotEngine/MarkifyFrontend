...
export class Module {
  ...
  css = {
    ...
    ".eSubToolShadow": `position: absolute; width: 100%; height: 100%; top: -16px; pointer-events: none; border-radius: inherit; overflow: hidden; z-index: -1`,
    ".eSubToolShadow:after": `position: absolute; width: calc(100% - 16px); height: calc(100% - 32px); top: 16px; content: ""; box-shadow: var(--lightShadow); border-radius: inherit`,
    ".eToolbarHolder[left] .eSubToolShadow": `padding: 16px 16px 16px 0; left: 0px`,
    ...
    ".eActionHolder[top] .eActionContainer": `--shadowPadding: 16px 16px 0; --shadowBottom: 0px; --shadowTop: 16px; bottom: 0px; padding-bottom: 4px; border-radius: 12px 12px 0 0`,
    ".eActionHolder[bottom] .eActionContainer": `--shadowPadding: 0 16px 16px; --shadowBottom: -16px; --shadowTop: 0px; top: 0px; padding-top: 4px; border-radius: 0 0 12px 12px`,
