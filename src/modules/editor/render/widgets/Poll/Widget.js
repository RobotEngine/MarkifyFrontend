...
export class Widget {
  ...
  css = {
    ...
    ".eWidgetPoll[voted]:not([editing]) .eWidgetPollOption[selected]:after": `content: ""; position: absolute; box-sizing: border-box; width: 100%; height: 100%; left: 0; top: 0; border: solid 2px var(--theme); border-radius: inherit; z-index: 1`,
    ...
    ".eWidgetPollOptionPercent": `display: none; width: fit-content; padding: 4px 8px; margin-right: 2px; background: var(--pageColor); box-shadow: var(--lightShadow); opacity: 0; color: var(--theme); border-radius: 12px; font-size: 13px; font-weight: 600; pointer-events: none; transition: opacity .4s`,
    ".eWidgetPoll[voted]:not([editing]) .eWidgetPollOption[selected] .eWidgetPollOptionPercent": `background: var(--theme); color: #fff`,
