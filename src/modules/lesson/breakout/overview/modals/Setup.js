export class Setup {
  ...
  progressFooterStyles = {
    ".brSetupProgress": `position: sticky; display: flex; flex-wrap: wrap; gap: 12px; width: calc(100% - 24px); bottom: 0; padding: 12px; font-size: 16px; background: rgba(var(--background), .9); backdrop-filter: blur(4px); justify-content: center; align-items: center; z-index: 2`,
