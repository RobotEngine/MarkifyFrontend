...
export class Page {
  ...
  css = {
    ...
    ".brgTopSection": `box-sizing: border-box; display: flex; height: 50px; padding: 6px 5px; flex-shrink: 0; align-items: center; background: var(--pageColor); box-shadow: var(--lightShadow); pointer-events: all`,
    ".brgTopHolder[scroll] .brgTopSection": `padding: 6px 0 !important; box-shadow: unset !important`,
    ".brgTopSection[left]": `padding-left: 6px !important; border-bottom-right-radius: 12px`,
    ...
    ".brgStatusHolder": `display: flex; width: 32px; height: 32px; margin: 0 4px; justify-content: center; align-items: center`,
