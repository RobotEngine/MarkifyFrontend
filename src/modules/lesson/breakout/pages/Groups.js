...
export class Page {
  ...
  css = {
    ...
    ".brgsTopSection": `box-sizing: border-box; display: flex; height: 50px; padding: 6px 5px; flex-shrink: 0; align-items: center; background: var(--pageColor); box-shadow: var(--lightShadow); pointer-events: all`,
    ".brgsTopHolder[scroll] .brgsTopSection": `padding: 6px 0 !important; box-shadow: unset !important`,
    ".brgsTopSection[left]": `padding-left: 6px !important; border-bottom-right-radius: 12px`,
