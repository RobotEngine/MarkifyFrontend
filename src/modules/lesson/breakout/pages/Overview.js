...
export class Page {
  ...
  css = {
    ...
    ".broTop": `position: absolute; box-sizing: border-box; display: flex; width: 100%; gap: 8px; padding-bottom: 8px; left: 0px; top: 0px; justify-content: space-between; overflow-x: auto; overflow-y: hidden; scrollbar-width: none`,
    ...
    ".broBottomSection": `box-sizing: border-box; display: flex; height: 50px; padding: 6px 5px; flex-shrink: 0; align-items: center; background: var(--pageColor); box-shadow: var(--lightShadow); border-radius: 12px 12px 0 0; pointer-events: all`,
    ...
    ".broWaitingRoomButtonHolderScroll": `box-sizing: border-box; display: flex; max-width: 100%; height: 50px; padding: 6px 5px; align-items: center; overflow-x: auto; overflow-y: hidden; scrollbar-width: none`,
    ...
    ".broTileHeaderName": `box-sizing: border-box; display: flex; gap: 0px; min-width: 0; margin: 4px; align-items: center; pointer-events: all; transition: .2s`,
    ...
    ".broTileMemberContent": `box-sizing: border-box; display: flex; width: 100%; gap: 6px; padding: 6px; overflow: hidden; justify-content: space-between`,
