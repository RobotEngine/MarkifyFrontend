...
export class Page extends PageFrame {
  ...
  css = {
    ...
    ".lHistoryDots": `position: absolute; display: flex; padding: 4px; left: 50%; bottom: 5%; transform: translate(-50%, 50%); background: rgba(var(--background), .9); backdrop-filter: blur(4px); border-radius: 16px`,
