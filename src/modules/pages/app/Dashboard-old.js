          ...
          <div class="dSidebarSection dSidebarAccountHolder">
            <div class="dSidebarUpdateAlert" closed>
              <div class="dSidebarUpdateAlertTitle">
                ...
                <button class="buttonAnim border">${close}</button>
              </div>
              <div divider></div>
              <a opennew style="--themeColor: var(--theme)"><div image>${exclamation}</div>See What's New</a>
              <button share style="--themeColor: var(--purple)"><div image>${share}</div>Share Markify</button>
            </div>
        ...
        <div class="dBannerHolder">
          <div class="dBanner" style="--theme: var(--breakoutTheme); --secondary: var(--breakoutSecondary); --hover: var(--breakoutHover); --darkShadow: var(--breakoutDarkShadow)">
            ...
            <div class="dBannerButtons">
              ...
              <button class="dBannerClose buttonAnim border">${close}</button>
            </div>
          </div>
        </div>
      ...
      if (this.sort.length > 20) { // Folder
        titleHolder.innerHTML = `<div class="dFolderInfo">
          ...
          <div class="dFolderInfoActions">
            <button class="dFolderRemove largeButton" option="deletefolder" dashboard title="Delete this folder." dropdowntitle="Delete Folder">${trash}</button>
          </div>
        </div>`;
