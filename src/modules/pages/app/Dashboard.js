...
export class Page extends PageFrame {
  ...
  css = {
    ...
    ".dSidebarOpen": `position: absolute; display: none; padding: 6px; left: 100%; bottom: 68px; background: rgba(var(--background), .9); backdrop-filter: blur(4px); border-radius: 0 36px 36px 0; z-index: 5`,
    ...
    ".dSidebarFolderArrow": `position: sticky; display: flex; width: 28px; height: 28px; right: 8px; margin-left: auto; justify-content: center; align-items: center; background: rgba(var(--background), .9); backdrop-filter: blur(4px); border-radius: 14px; z-index: 1; transition: .1s`,
    ...
    ".dSidebarAccountHolder": `--percent: 0; display: flex; flex-direction: column; padding: 8px; bottom: 0px; margin-top: auto; align-items: center; background: rgba(var(--background), calc(.9 * var(--percent))); backdrop-filter: blur(calc(4px * var(--percent))); transition: .2s`,
    ...
    ".dSelectedTitleHolder": `--percent: 0; position: sticky; box-sizing: border-box; display: flex; width: 100%; padding: 20px; top: 0px; background: rgba(var(--background), calc(.9 * var(--percent))); backdrop-filter: blur(calc(4px * var(--percent))); z-index: 2; transition: background .2s, backdrop-filter .2s, box-shadow .2s`,
